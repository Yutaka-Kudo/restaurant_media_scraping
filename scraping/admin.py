...
class Fes_hp_scrapeAdmin(admin.ModelAdmin):
    list_display = ("date", "week","pv_all_sp","pv_top_sp","pv_all_pc","pv_top_pc")
...
class Fes_gn_scrapeAdmin(admin.ModelAdmin):
    list_display = ("date", "week","total_pv_sp","top_pv_sp","total_pv_pc","top_pv_pc","total_pv_app","top_pv_app","reserve_total")
...
class Fes_tb_scrapeAdmin(admin.ModelAdmin):
    list_display = ("date", "week","total_pv_sp","top_pv_sp","total_pv_pc","top_pv_pc","net_reserve")
